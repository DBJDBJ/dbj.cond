...
//
 ```
 Standard and default comparison used is one of strict equality. 
...
Swappable comparators are very powerfull feature. Just please be sure to understand what is each one doing and plan to use it accordingly.
