...
The more you use it, the more it becomes clear why you have choosen it. Essentialy it replace ```if() else``` ans ```switch```. It is simple and effective. It also has an obvious returned value vs the ```if/else``` cascades and a ```switch``` statement.
